...
namespace Apparat
{
  public class Screenshots
  {
    ...
    public void MakeScreenshot(DeviceManager dm)
    {
      //try
      //{
      //  SharpDX.Direct3D11.Resource.SaveTextureToFile(dm.context,
      //    dm.renderTarget.Resource,
      //    SharpDX.Direct3D11.ImageFileFormat.Jpg,
    ...
    //  try
    //  {
    //    SharpDX.Direct3D11.Resource.SaveTextureToFile(dm.context, dm.renderTarget.Resource, SharpDX.Direct3D11.ImageFileFormat.Png, fileName);
    //  }
    //  catch (Exception ex)
    //  {
    //    Console.WriteLine(ex.ToString());
    ...
    //public void MakeScreenshot(DeviceManager dm, SharpDX.Direct3D11.ImageFileFormat format)
    //{
    //  try
    //  {
    //    String fileName = fileNamePrefix + format.ToString();
    //    SharpDX.Direct3D11.Resource.SaveTextureToFile(dm.context, dm.renderTarget.Resource, format, fileName);
    //  }
    //  catch (Exception ex)
    //  {
    //    Console.WriteLine(ex.ToString());
    ...
    ///// <param name="format">Image file format (bmp, jpg, png)</param>
    ///// <param name="fileName">Filename.</param>
    //public void MakeScreenshot(DeviceManager dm, SharpDX.Direct3D11.ImageFileFormat format, String fileName)
    //{
    //  try
    //  {
    //    SharpDX.Direct3D11.Resource.SaveTextureToFile(dm.context, dm.renderTarget.Resource, format, fileName);
    ...
    //    SharpDX.Direct3D11.Resource.SaveTextureToFile(dm.context, dm.renderTarget.Resource, SharpDX.Direct3D11.ImageFileFormat.Png, defaultScreenshotFileName);
    ...
    ///// <param name="format">Image file format (bmp, jpg, png)</param>
    ///// <param name="fileName">Filename.</param>
    //public void MakeScreenshot(DeviceManager dm, Scene scene, int width, int height, SharpDX.Direct3D11.ImageFileFormat format, string fileName)
    //{
    //  try
    //  {
    //    Viewport OriginalViewport = dm.viewport;
