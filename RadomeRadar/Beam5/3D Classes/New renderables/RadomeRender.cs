...
namespace Apparat
{
    public class RadomeMesh : Renderable
    {
        ...
        public RadomeMesh(string lable, List<double> x, List<double> y, List<double> z, List<int> P1, List<int> P2, List<int> P3, Color color)
        {
            Lable = lable;
            Color = color;
        ...
        public RadomeMesh(string lable, List<double> x, List<double> y, List<double> z, Color color)
        {
            Lable = lable;
            Color = color;
            ...
            indexStride = Marshal.SizeOf(typeof(int)); // 2 bytes
            indexBufferSizeInBytes = numIndices * indexStride;
